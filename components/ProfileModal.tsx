  ...
  return (
    ...
    >
      <div
        ...
        <div
          className="border-t border-gray-100 bg-white flex items-center gap-3 rounded-b-xl"
          style={{ paddingLeft: "20px", paddingRight: "20px", paddingTop: "12px", paddingBottom: "24px" }}
        >
          <button
            onClick={reset}
